...
function CategorySale({ obj }) {
  ...
  const ProductCategory = (e) => {
    ...
    router.push({
      ...
      query: { categorys: obj.data().category },
    });
  };
  ...
  return (
    <>
      <div
        className={`${"col-sm-4 col-md-12 col-sm-12 hidden-sm hidden-xs"} ${
          styles.box_product_outer
        }`}
      ...
      >
        <div className={styles.box_product}>
          ...
          <h6 role="button" onClick={ProductCategory}>
            <a>{obj.data().category}</a>
          </h6>
